...
>(({ side = "left", variant = "sidebar", collapsible = "icon", className, children, ...props }, ref) => {
  ...
  if (collapsible === "none" && !isMobile) {
    return (
      <div
        className={cn(
          "flex h-full w-[--sidebar-width] flex-col bg-gradient-to-b from-white to-gray-50/30 border-r border-gray-200/60",
          className,
        )}
        ref={ref}
        {...props}
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-mobile="true"
          className="w-[--sidebar-width] bg-gradient-to-b from-white to-gray-50/30 p-0 text-foreground [&>button]:hidden"
          style={
            {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "duration-300 relative h-svh bg-transparent transition-[width] ease-out",
      ...
      <div
        className={cn(
          "duration-300 fixed inset-y-0 z-10 hidden h-svh transition-[left,right,width] ease-out md:flex",
      ...
      >
        <div
          data-sidebar="sidebar"
          className={cn(
            "flex h-full w-full flex-col bg-gradient-to-b from-white to-gray-50/30 border-r border-gray-200/60 shadow-sm",
...
const SidebarSeparator = React.forwardRef<React.ElementRef<typeof Separator>, React.ComponentProps<typeof Separator>>(
  ({ className, ...props }, ref) => {
    return <Separator ref={ref} data-sidebar="separator" className={cn("mx-4 my-2 bg-border", className)} {...props} />
  },
)
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        className={cn(
          "duration-200 flex h-8 shrink-0 items-center rounded-md px-3 text-xs font-medium text-muted-foreground outline-none ring-ring transition-[margin,opa] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
  ...
  (
    ...
    return (
      <Tooltip>
        ...
        <TooltipContent side="right" align="center" className="ml-1" {...tooltipContent} />
      </Tooltip>
    )
  },
)
